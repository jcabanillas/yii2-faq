...
class FaqGroups extends Faq
{
    ...
    /**
     * @inheritdoc
     * @return \jcabanillas\faq\models\queries\FaqGroupsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \jcabanillas\faq\models\queries\FaqGroupsQuery(get_called_class());
    }
